...
Substitutes forensic-case-manager, Forensic Case Manager, and __ORG_NAME__ placeholders.
...
REPLACEMENTS_TEMPLATE = [
    ("forensic_case_manager", "{slug_underscore}"),
    ("forensic-case-manager", "{slug_kebab}"),
    ("Forensic Case Manager", "{name}"),
    ("forensic-case-manager", "{slug_kebab}"),
    ("Forensic Case Manager", "{name}"),
    ("__ORG_NAME__", "{org}"),
]
