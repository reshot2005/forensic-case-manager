...
forensic-case-manager analyze sample_data/example.txt --json

# Generate HTML report
forensic-case-manager analyze sample_data/example.txt --html report.html
```
...
forensic-case-manager analyze sample_data/example.txt \
  --json --html report.html --csv findings.csv --sarif results.sarif

# Mark as sample data (banner in HTML report)
forensic-case-manager analyze sample_data/example.txt --sample --html report.html

# Limit file size
forensic-case-manager analyze large.bin --max-bytes 10485760
```
